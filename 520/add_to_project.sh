...
## Add user as member to the assignment project with Reporter role
  ...
  "https://gitlab.com/api/v4/projects/$assignmentproject/members?user_id=$USER_ID&access_level=20" | jq '.'
